        ...
        {products.length > 0 && <><ProductList>
            {products.map(item => {
                ...
                return <TableRow>
                    ...
                    {checkout && <CartCell colSpan={3}>
                        <Price style={{ whiteSpace: 'nowrap' }}>{item.count} x {formatPrice(item.product.sellPrice)}</Price>
                    </CartCell>}
                </TableRow>
            })}
            <TableRow>
            ...
            {!checkout && <RowContainer style={{ marginLeft: 'auto', marginTop: '1rem' }}>
